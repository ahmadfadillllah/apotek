...
<body>
                        ...
                        <div class="card mt-4">
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Login untuk masuk ke halaman dashboard</p>
                                </div>
                                <div class="p-2 mt-4">
    ...
    <!-- password-addon init -->
    <script src="{{ asset('admin/themesbrand.com/velzon/html/default') }}/assets/js/pages/password-addon.init.js"></script>
</body>
