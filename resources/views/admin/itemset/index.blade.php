                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header">
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#itemset" style="float: right">
                                            Import Itemset
                                        </button>
                                        @include('admin.itemset.modal.itemset')
                                        <h5 class="card-title mb-0">Daftar Transaksi</h5>
                                        <p>Jumlah Data: {{ $itemset->count() }}</p>
                                    </div>
                                        ...
                                        <table id="example"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $i->item }}</td>
                                                    <td>
                                                        <a href="{{ route('itemset.destroy', $i->id) }}" type="submit"
                        ...
                        <div class="card h-100 rounded-0">
                            <div class="card-body p-0">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                ...
                                                <div class="d-inline-flex gap-2 border border-dashed p-2 mb-2">
                                                    <a href="apps-ecommerce-product-details.html"
                                                        ...
                                                        <img src="{{ asset('admin/themesbrand.com/velzon/html/default') }}/assets/images/products/img-8.png"
                                                            alt="" class="img-fluid d-block" />
                                                    </a>
                                                    <a href="apps-ecommerce-product-details.html"
                                                        class="bg-light rounded p-1">
                                                        <img src="{{ asset('admin/themesbrand.com/velzon/html/default') }}/assets/images/products/img-2.png"
                                                            alt="" class="img-fluid d-block" />
                                                    </a>
                                                    <a href="apps-ecommerce-product-details.html"
                                                        class="bg-light rounded p-1">
                                                        <img src="{{ asset('admin/themesbrand.com/velzon/html/default') }}/assets/images/products/img-10.png"
                                                            alt="" class="img-fluid d-block" />
                                                    </a>
                                                </div>
                                ...
                                <div class="card sidebar-alert bg-light border-0 text-center mx-4 mb-0 mt-3">
                                    <div class="card-body">
                                        <img src="{{ asset('admin/themesbrand.com/velzon/html/default') }}/assets/images/giftbox.png"
                                            alt="">
                                        <div class="mt-4">
