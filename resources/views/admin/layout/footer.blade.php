        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="text-sm-end d-none d-sm-block">
                    Design & Develop by <a href="https://adhyy.my.id" target="_blank">Ahmad Fadillah</a>
                </div>
            </div>
        </div>
    </div>
...
<!-- Chart JS -->
<script src="{{ asset('admin/themesbrand.com/velzon/html/default') }}/assets/libs/chart.js/chart.min.js"></script>

<!-- chartjs init -->
<script src="{{ asset('admin/themesbrand.com/velzon/html/default') }}/assets/js/pages/chartjs.init.js"></script>
...
<!-- datatables -->
<script src="{{ asset('admin/themesbrand.com/velzon/html/default') }}/assets/js/pages/datatables.init.js"></script>
...
<script src="{{ asset('admin/themesbrand.com/velzon/html/default') }}/assets/libs/%40simonwep/pickr/pickr.min.js">
</script>

<!-- init js -->
<script src="{{ asset('admin/themesbrand.com/velzon/html/default') }}/assets/js/pages/form-pickers.init.js"></script>
